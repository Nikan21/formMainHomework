...
export default function LoginForm() {
  ...
  const scheme = yup.object().required().shape({
    email: yup.string().matches(/[A-z][a-z][0-9][.@]/, 'Email is not valid format').required('Field is empty'),
            ...
            return(
                <Form className= {styles.form}>
                  ...
                  <label className = {styles.labelEmail}>
                    <Field className = {colorInputEmail} name = 'email' type = 'text' placeholder = 'Email adress'/>
                    <div className = {errorEmails}><ErrorMessage  name = 'email'/></div>
                    </label>

                    <label className = {styles.labelPassword}>
                    <Field className = {colorInputPassword} name = 'password' type = 'password' placeholder = 'Password'/>
                    <div className = {errorPassword}><ErrorMessage  name = 'password'/></div>
                    </label>
